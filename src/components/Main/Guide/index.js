    ...
    <Wrapper>
      ...
      <TextBox>
        ...
        <Content>
          ...
          <hr />
          <br />
          <strong>1. 로스터 구성 방법</strong>
          <br />
          - ⚾️ FANTASY BASEBALL은 10인으로 이루어진 로스터에 유저가 자신이 원하는 만큼 베팅 금액을 걸 수 있는 구조입니다.
          <br />
          - 유저가 선택할 수 있는 선수들 리스트는 당일 선발 라인업을 기준으로 각 팀당 10명 씩 총 100명이 매일 갱신됩니다.
          <br />
          - 로스터로 선택할 수 있는 10인은&nbsp;
          <u>좌익수, 중견수, 우익수, 1루수, 2루수, 3루수, 유격수, 투수, 포수, 지명타자</u>
          &nbsp;
          등 각각의 포지션을 가지고 있습니다.
          <br />
